...
- Create Angular project with ng: `ng new "ublockfilterutility.client" --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ublockfilterutility.client.esproj`).
